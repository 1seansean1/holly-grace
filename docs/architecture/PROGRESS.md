...
| 2.6 | Implement singleton loader | pending (crit) | 1d | 1.8, 2.5 |  |
...
| 3a.12 | Run gate, produce pass/fail report | pending (crit) | 0.5d | 3a.10, 3a.11 |  |
| | **Slice 2** | | | | |
...
| 7.1 | Extend AST scanner with per-module rules | pending (crit) | 0.5d | 5.6 |  |
| 7.2 | Add wrong-decorator detection | pending (crit) | 0.5d | 7.1 |  |
