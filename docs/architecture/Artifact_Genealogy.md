...
| 31 | Test Suite (263 tests) | `tests/unit/test_*.py` (13 modules) | ε | 55 KB | All ε modules + TGS |
...
2026-02-18  Kernel exceptions, schema registry, and K1 orchestration (Task 3.7):
                     ...
                     263 total tests across 13 test modules
