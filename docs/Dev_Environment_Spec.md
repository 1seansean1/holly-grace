...
**Build Tool:** `Vite` (per RTD v0.1.0.2)
...
The RTD v0.1.0.2 (mermaid) defines the target directory layout. **Critical directories exist in Phase A scaffold (step 4):**
...
│   └── partition_maint.py
├── docs/                           # Documentation
│   ├── architecture.yaml           # Extracted SAD (machine-readable)
│   ├── Dev_Environment_Spec.md     # This file
│   ├── Interface_Control_Document_v0.1.md
│   ├── Component_Behavior_Specs.md
...
- SAD v0.1.0.2 (Kernel → Core boundaries)
```
